...
const INGREDIENT_ID = 'all-purpose-flour';
const COMMON_WEIGHTS: number[] = [25, 50, 75, 100, 120, 125, 130, 140, 150, 160, 175, 180, 200, 225, 240, 250, 300, 350, 360, 400, 480, 500, 750, 1000];
