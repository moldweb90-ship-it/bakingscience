export const GENERIC_GRAM_WEIGHTS = [
  ...
  160, 170, 175, 180, 200, 225, 240, 250, 270, 275, 280, 283, 300, 340, 350, 400, 450,
  475, 500, 600, 700, 750, 800, 900, 1000,
];

export const GENERIC_CUP_VALUES = [
  0.125, 0.25, 0.333, 0.5, 0.667, 0.75, 1, 1.25, 1.333, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3, 3.5, 3.75, 4, 4.25, 4.5, 5, 8,
];
