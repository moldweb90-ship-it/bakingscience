...
const resourceLinks = [
  ...
  { label: '1/2 cup in teaspoons', href: '/cups-to-teaspoons/1-2-cup-to-teaspoons/' },
  { label: '240 ml to grams', href: '/ml-to-grams/240-ml-to-grams/' },
      ...
      <div className="mx-auto max-w-page px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">
            &copy; 2026 BakingConverter.com - Precision baking measurements for everyone.
          </p>
          <button
